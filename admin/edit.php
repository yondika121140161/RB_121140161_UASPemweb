...
<link rel="stylesheet" href="style.css">
    ...
    <title>Admin Edit | Manajemen Buku</title>
</head>
<body>
...
<td><label>
<input type="text" name="judulbuku" value="<?php echo $judulbuku; ?>" />
</label></td>
</tr>
...
<tr align="center">
<td colspan="2"><label>
<input type="submit" class="btn btn-primary mt-2" name="submit" value="Simpan Perubahan Data">
</label></td>
</tr>
</table>
</form>
